...
var setCurrentDir = function setCurrentDir(dir) {
...
},{"./ee":4}],4:[function(require,module,exports){
'use strict';
...
var ee = new _eventemitter.EventEmitter2();
exports.default = ee;
...
var iframe = exports.iframe = document.createElement('iframe');
// iframe.src = 'http://localhost:8000'
// iframe.src = 'http://course.jsx.fr/courses/react/plusieurs-composants'
Object.keys(iframeStyles).forEach(function (k) {
  iframe.style[k] = iframeStyles[k];
});

var setSource = exports.setSource = function setSource(src) {
...
var setError = exports.setError = function setError(message) {
  var html = '<div style="padding:20px"><h1>Too Bad</h1><p>' + encodeURIComponent(message) + '</p><img style="max-width:200px;margin 0 auto;display:block" src="https://bhubr.github.io/img/grumpy-cat.jpg" alt="grumpy cat" /></div>';
  var src = 'data:text/html;charset=UTF-8,' + html;
  if (iframe.src !== src) {
...
var _currentDir = require('./currentDir');

var _currentDir2 = _interopRequireDefault(_currentDir);
...
},{"./currentDir":3,"./ee":4,"./iframe":5,"./ws":7}],7:[function(require,module,exports){
'use strict';
...
var ERROR_MSG = 'Le serveur Express dans <code>react-tutorial/express</code> doit être lancé avec <code>node server.js</code>.';
var ws = {
  interval: -1,
  client: null
};
