...
var setError = exports.setError = function setError(message) {
  var html = '<div style="padding:20px"><h1>Too Bad</h1><p>' + message + '</p><img style="max-width:200px;margin 0 auto;display:block" src="https://bhubr.github.io/img/grumpy-cat.jpg" alt="grumpy cat" /></div>';
...
},{"./ee":3,"./iframe":4,"./ws":6}],6:[function(require,module,exports){
'use strict';
...
var onopen = function onopen() {
  ...
  (0, _iframe.setSource)('http://localhost:8000');
  sendNumber();
  stopPolling();
};
...
var onerror = function onerror() {
  ...
  (0, _iframe.setError)('Server not running');
  ws.client = null;
  startPolling();
};
...
var onclose = function onclose() {
  ...
  (0, _iframe.setError)('Le serveur Express dans <code>react-app-tdd/express</code> doit être lancé avec <code>node server.js</code>.');
  ws.client = null;
  startPolling();
};
